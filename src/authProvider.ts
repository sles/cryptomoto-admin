import {AuthProvider, useDataProvider} from 'react-admin';
...
const authProvider: AuthProvider = {
    ...
    checkAuth: () => {
        return localStorage.getItem('token') && localStorage.getItem('token') != 'undefined' ? Promise.resolve() : Promise.reject()
    },
    ...
    getIdentity: () => {
        ...
        return Promise.resolve({
            id: 'user',
            fullName: fullName ? fullName: 'Admin',
            avatar:
